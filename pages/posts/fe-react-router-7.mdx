...
## [createRoutesFromChildren](https://reactrouter.com/en/main/utils/create-routes-from-children)
...
## [generatePath](https://reactrouter.com/en/main/utils/generate-path)
...
## [Location](https://reactrouter.com/en/main/utils/location)

React Router 中 "location" 的接口定义。

## [matchPath](https://reactrouter.com/en/main/utils/match-path)
...
## [matchRoutes](https://reactrouter.com/en/main/utils/match-routes)
...
## [renderMatches](https://reactrouter.com/en/main/utils/render-matches)
...
## [resolvePath](https://reactrouter.com/en/main/utils/resolve-path)
...
<Giscus />
<Anchor name="React Router v6 官方文档翻译 （七） ---- 内置API" />
